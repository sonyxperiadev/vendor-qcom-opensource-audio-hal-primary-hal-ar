...
include vendor/qcom/opensource/audio-hal/primary-hal-ar/configs/kalama/audio-modules.mk
...
CONFIG_HAL_SRC_DIR := vendor/qcom/opensource/audio-hal/primary-hal-ar/configs/kalama
...
PRODUCT_COPY_FILES += \
    $(TOPDIR)vendor/qcom/opensource/audio-hal/primary-hal-ar/configs/common/init.qti.audio.debug.sh:$(TARGET_COPY_OUT_VENDOR)/bin/init.qti.audio.debug.sh
endif
